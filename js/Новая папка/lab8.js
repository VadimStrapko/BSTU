...
const copyUser = {...user}
//Копирование массива чисел,  создает поверхностную копию массива
const copyNumbers = {...numbers}
//создается поверхностная копия объекта user1
const copyUser1 = {...user1}
console.log(user1.location.city)
copyUser1.location.city = 'Brest'
console.log(user1.location.city)
console.log(copyUser1.location.city)
//создают поверхностные копии соответствующих объектов
...
*/
//Копирование и изменение свойства department.group
copyUser5.studies = {...user5.studies}
copyUser5.studies.department = {...user5.studies.department}
//значение свойства group в копии объекта department на 12
...
//Копирование и изменение свойства exams[1].mark
...
*/
//Копирование и изменение свойства exams[0].professor.name и exams[1].professor.name
...
//Вывод значений имен преподавателей
